...
import (
	...
	snapshotdbdevv1alpha1 "github.com/db/snap/pkg/apis/snapshot.db.dev/v1alpha1"
	versioned "github.com/db/snap/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/db/snap/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/db/snap/pkg/generated/listers/snapshot.db.dev/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SnapshotV1alpha1().Snapshots(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SnapshotV1alpha1().Snapshots(namespace).Watch(context.TODO(), options)
			},
		},
		&snapshotdbdevv1alpha1.Snapshot{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *snapshotInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&snapshotdbdevv1alpha1.Snapshot{}, f.defaultInformer)
}

...
import (
	...
	v1alpha1 "github.com/db/snap/pkg/apis/snapshot.db.dev/v1alpha1"
	"github.com/db/snap/pkg/generated/clientset/versioned/scheme"
...
// SnapshotV1alpha1Client is used to interact with features provided by the snapshot.db.dev group.
type SnapshotV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SnapshotV1alpha1Client) Snapshots(namespace string) SnapshotInterface {
